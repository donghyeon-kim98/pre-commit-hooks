...
def test_return_expected_branch_name(temp_git_dir, branch_with_ticket_id, git_helpers):
...
def test_return_expected_commit_msg(temp_git_dir, commit_editmsg_ref, git_helpers):
    with temp_git_dir.as_cwd():
